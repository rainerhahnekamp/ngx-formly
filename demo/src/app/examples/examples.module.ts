    ...
    RouterModule.forChild([
      { path: '', children: [
        ...
        { path: 'advanced', children: [
          ...
          { path: 'grid-integration', loadChildren: './advanced/grid-integration/config.module#ConfigModule' },
        ...
        { path: 'other', children: [
          ...
          { path: 'cascaded-select-json', loadChildren: './other/cascaded-select-json/config.module#ConfigModule' },
